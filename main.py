...
# Esto asegura que las tablas se creen en Supabase al iniciar en Render
models.Base.metadata.create_all(bind=engine)

app = FastAPI(title="FruverOS Pro")

# --- CONFIGURACIÓN DE SEGURIDAD ---
# En Render, puedes configurar SECRET_KEY en las variables de entorno
SECRET_KEY = os.getenv("SECRET_KEY", "cambia_esto_por_una_clave_larga_y_aleatoria_en_produccion")
ALGORITHM = "HS256"
